...
{
    'cm12ClutchInArray', {
       	{'CL0',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL1',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
    }
}
{
    'cm12GearBoxInArray', {
       	{'GB0',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
    }
}
{
...
{
    'cm12ClutchOutArray', {
       	{'CL0',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL1',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
    }
}
{
    'cm12GearBoxOutArray', {
       	{'GB0',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
    }
}
{
...
{
    'cm12GearBoxArray', {
       	{'GB0',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBox', -1, 'real', 'Sample'};
    }
}
{
    'cm12DriveSrcInArray', {
...
}
{
    'cm12ClutchInArray', {
       	{'CL0',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL1',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL2',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL3',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL4',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL5',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL6',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL7',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL8',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL9',	1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL10',1,'cm12ClutchIn', -1, 'real', 'Sample'};
       	{'CL11',1,'cm12ClutchIn', -1, 'real', 'Sample'};
    }
}
{
    'cm12GearBoxInArray', {
       	{'GB0',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB2',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB3',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB4',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB5',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB6',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB7',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB8',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB9',	1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB10',1,'cm12GearBoxIn', -1, 'real', 'Sample'};
       	{'GB11',1,'cm12GearBoxIn', -1, 'real', 'Sample'};
    }
}
{
    'cm12PTControlWheelInArray', {
...
}
{
    'cm12ClutchOutArray', {
       	{'CL0',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL1',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL2',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL3',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL4',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL5',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL6',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL7',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL8',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL9',	1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL10',1,'cm12ClutchOut', -1, 'real', 'Sample'};
       	{'CL11',1,'cm12ClutchOut', -1, 'real', 'Sample'};
    }
}
{
    'cm12GearBoxOutArray', {
       	{'GB0',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB2',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB3',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB4',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB5',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB6',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB7',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB8',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB9',	1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB10',1,'cm12GearBoxOut', -1, 'real', 'Sample'};
       	{'GB11',1,'cm12GearBoxOut', -1, 'real', 'Sample'};
    }
}
{
    'cm12PTControlWheelOutArray', {
...
}
{
    'cm12GearBoxArray', {
       	{'GB0',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB1',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB2',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB3',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB4',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB5',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB6',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB7',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB8',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB9',	1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB10',1,'cm12GearBox', -1, 'real', 'Sample'};
       	{'GB11',1,'cm12GearBox', -1, 'real', 'Sample'};
    }
}
{
    'cm12DriveSrcInArray', {
...
}
{
	...
	{'ClutchIn', 	1, 'cm12ClutchInArray', -1, 'real', 'Sample'};
	{'GearboxIn',   1, 'cm12GearBoxInArray', -1, 'real', 'Sample'};
...
}
{
	...
	{'ISGOut',		1,'cm12MotorOut', 	-1, 'real', 'Sample'};
       	...
       	{'ClutchOut',		1,'cm12ClutchOutArray', -1, 'real', 'Sample'};
       	{'GearboxOut',		1,'cm12GearBoxOutArray',-1, 'real', 'Sample'};
...
}
{
	...
	{'L_d',	                1,'double', -1, 'real', 'Sample'};
	{'L_q',	                1,'double', -1, 'real', 'Sample'};
	{'Psi_PM',	        1,'double', -1, 'real', 'Sample'};
    }
}
{
    'cm12FGearArray', {
...
}
{
	...
	{'DL_iDiff_mean',	1,'double', 		-1, 'real', 'Sample'};
       	...
       	{'Gearbox',		1,'cm12GearBoxArray', 	-1, 'real', 'Sample'};
