...
Simulink.Bus.cellToObject({
{
	...
	{'CtrlInOptSpring',    	1, 'cm24CtrlInFrcEl', -1, 'real', 'Sample'};
	{'CtrlInOptDamper',    	1, 'cm24CtrlInFrcEl', -1, 'real', 'Sample'};
	{'CtrlInOptBuffer',    	1, 'cm24CtrlInFrcEl', -1, 'real', 'Sample'};
	{'CtrlInOptStabi',    	1, 'cm24CtrlInFrcEl', -1, 'real', 'Sample'};
    }
}
{
    'cmSusp_FrcSystemOut', {
	...
	{'CtrlOutOptSpring',    1, 'cm24CtrlOutFrcEl', -1,'real', 'Sample'};
	{'CtrlOutOptDamper',    1, 'cm24CtrlOutFrcEl', -1,'real', 'Sample'};
	{'CtrlOutOptBuffer',    1, 'cm24CtrlOutFrcEl', -1,'real', 'Sample'};
	{'CtrlOutOptStabi',    1,  'cm24CtrlOutFrcEl', -1,'real', 'Sample'};
    }
}
% CfgInput Bus
{
