"""
LKA_Main.py
Entry point. Runs the 30 Hz lateral control loop.
Single unified PID controller with feedforward and rate limiting.

Uses SimControlInteractive with APO connection for proper DVA access.
"""
